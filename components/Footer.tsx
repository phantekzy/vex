                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-md:gap-12">
                    ...
                    <div className="space-y-4 col-span-2 md:col-span-1 max-md:col-span-2">
                        ...
                        <div className="flex space-x-4 text-foreground/80">
                            <Link href="#" className="hover:text-primary transition-colors" aria-label="Visit us on Twitter">
                            ...
                            <Link href="#" className="hover:text-primary transition-colors" aria-label="Visit us on Facebook">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                            </Link>
                            <Link href="#" className="hover:text-primary transition-colors" aria-label="Visit us on GitHub">
